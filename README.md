🔐 SOC Analyst Portfolio - Sindhu Eppakayala
> Hands-on cybersecurity labs demonstrating SOC Analyst skills
...
| **Network Analysis** | Wireshark, NetworkMiner, Snort |
| **Endpoint Security** | Windows Event Logs, Linux logs |
| **Threat Detection** | MITRE ATT&CK, SIEM alert triage |
...
- **/screenshots** → Visual proof of completed labs
